...
"[project]/.next-internal/server/app/api/favorites/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/queries/favorites.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function addFavorite(userId, petId) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insertInto("favourites").values({
        userId,
        petId
...
async function removeFavorite(userId, petId) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].deleteFrom("favourites").where("userId", "=", userId).where("petId", "=", petId).execute();
}
async function getUserFavorites(userId) {
    const favorites = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].selectFrom("favourites").select([
        "petId"
    ]).where("userId", "=", userId).execute();
    return favorites.map((f)=>f.petId);
}
async function getUserFavoritedPets(userId) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].selectFrom("favourites as f").innerJoin("pets as p", "p.id", "f.petId").leftJoin("petImages as pi", (j)=>j.onRef("pi.petId", "=", "p.id").on("pi.orderIdx", "=", 0)).select([
        "p.id",
        "p.name",
        "p.ageGroup",
        "p.breed",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$favorites$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/queries/favorites.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$favorites$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$favorites$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
async function GET() {
    try {
        ...
        const favoritedPets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$favorites$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserFavoritedPets"])(userId);
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$favorites$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addFavorite"])(userId, petId);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])();
    } catch (error) {
...
async function DELETE(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$favorites$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["removeFavorite"])(userId, petId);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])();
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a1e80b9._.js.map