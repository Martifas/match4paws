...
"[project]/src/hooks/useProfileForm.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useProfileForm(initial = {
    ...
    const [fields, set] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initial);
    ...
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((k, v)=>{
        set((f)=>({
                ...f,
                [k]: v
            }));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useProfileForm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useProfileForm.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function ProfileManagement() {
    ...
    const initialProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
            name: user?.name ?? '',
            phone: user?.phone ?? '',
    ...
    const { fields: form, update, dirty, resetDirty } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useProfileForm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(initialProfile);
...
//# sourceMappingURL=src_1f21208a._.js.map