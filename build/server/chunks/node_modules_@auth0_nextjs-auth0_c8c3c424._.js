...
async function encrypt(payload, secret, expiration, additionalHeaders) {
    const encryptionSecret = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$node$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(DIGEST, secret, "", ENCRYPTION_INFO, BYTE_LENGTH);
    const encryptedCookie = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$encrypt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EncryptJWT"](payload).setProtectedHeader({
        enc: ENC,
        alg: ALG,
        ...additionalHeaders
...
async function decrypt(cookieValue, secret, options) {
    const encryptionSecret = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$node$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(DIGEST, secret, "", ENCRYPTION_INFO, BYTE_LENGTH);
    const cookie = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$decrypt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jwtDecrypt"])(cookieValue, encryptionSecret, {
        ...options,
        ...{
            clockTolerance: 15
        }
 ...
 */ const signingSecret = (secret)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$node$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])("sha256", secret, "", "JWS Cookie Signing", BYTE_LENGTH);
async function verifySigned(k, v, secret) {
    ...
    const flattenedJWS = {
        protected: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$util$2f$base64url$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__["base64url"].encode(JSON.stringify({
            alg: "HS256",
            b64: false,
            crit: [
                "b64"
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jws$2f$flattened$2f$verify$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["flattenedVerify"])(flattenedJWS, key, {
            algorithms: [
                "HS256"
            ]
        });
...
async function sign(name, value, secret) {
    const key = await signingSecret(secret);
    const { signature } = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jws$2f$flattened$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FlattenedSign"](new TextEncoder().encode(`${name}=${value}`)).setProtectedHeader({
        alg: "HS256",
        b64: false,
        crit: [
            "b64"
...
"[project]/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [app-route] (ecmascript) <locals>");
...
function createRouteUrl(url, base) {
    return new URL((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureNoLeadingSlash"])(url), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureTrailingSlash"])(base));
}
class AuthClient {
    constructor(options){
        // dependencies
    ...
    async startInteractiveLogin(options = {}) {
        ...
        const codeVerifier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateRandomCodeVerifier"])();
        const codeChallenge = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculatePKCECodeChallenge"])(codeVerifier);
        const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateRandomState"])();
        const nonce = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateRandomNonce"])();
        ...
        if (error) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("An error occured while trying to initiate the login request.", {
                status: 500
            });
        }
    ...
    async handleLogout(req) {
        ...
        if (discoveryError) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("An error occured while trying to initiate the logout request.", {
                status: 500
            });
        }
    ...
    async handleCallback(req) {
        ...
        if (!state) {
            return this.onCallback(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MissingStateError"](), {}, null);
        }
        ...
        let codeGrantParams;
        try {
            codeGrantParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateAuthResponse"])(authorizationServerMetadata, this.clientMetadata, req.nextUrl.searchParams, transactionState.state);
        } catch (e) {
            return this.onCallback(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthorizationError"]({
        ...
        const redirectUri = createRouteUrl(this.routes.callback, this.appBaseUrl); // must be registed with the authorization server
        const codeGrantResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authorizationCodeGrantRequest"])(authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), codeGrantParams, redirectUri.toString(), transactionState.codeVerifier, {
            ...this.httpOptions(),
        ...
        let oidcRes;
        try {
            oidcRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processAuthorizationCodeResponse"])(authorizationServerMetadata, this.clientMetadata, codeGrantResponse, {
                expectedNonce: transactionState.nonce,
                maxAge: transactionState.maxAge,
                requireIdToken: true
            });
        } catch (e) {
            return this.onCallback(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthorizationCodeGrantError"]({
                cause: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                    code: e.error,
                    message: e.error_description
                })
        ...
        const idTokenClaims = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getValidatedIdTokenClaims"])(oidcRes);
        let session = {
            user: idTokenClaims,
            tokenSet: {
        ...
        if (this.beforeSessionSaved) {
            ...
            session.user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["filterClaims"])(idTokenClaims);
        }
     ...
     */ async getTokenSet(tokenSet, forceRefresh) {
        ...
        if (tokenSet.refreshToken) {
            ...
            if (forceRefresh || tokenSet.expiresAt <= Date.now() / 1000) {
                ...
                const refreshTokenRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshTokenGrantRequest"])(authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), tokenSet.refreshToken, {
                    ...this.httpOptions(),
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests
                });
                let oauthRes;
                try {
                    oauthRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processRefreshTokenResponse"])(authorizationServerMetadata, this.clientMetadata, refreshTokenRes);
                } catch (e) {
                    console.error(e);
                    return [
                        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AccessTokenError"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].FAILED_TO_REFRESH_TOKEN, "The access token has expired and there was an error while trying to refresh it. Check the server logs for more information."),
                        null
                    ];
                }
    ...
    async discoverAuthorizationServerMetadata() {
        ...
        try {
            const authorizationServerMetadata = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["discoveryRequest"])(issuer, {
                ...this.httpOptions(),
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests
            }).then((response)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processDiscoveryResponse"])(issuer, response));
    ...
    async verifyLogoutToken(logoutToken) {
        ...
        const keyInput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwks$2f$remote$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRemoteJWKSet"])(new URL(authorizationServerMetadata.jwks_uri), {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwks$2f$remote$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jwksCache"]]: this.jwksCache
        });
        const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$verify$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jwtVerify"])(logoutToken, keyInput, {
    ...
    async authorizationUrl(params) {
        ...
        if (this.pushedAuthorizationRequests) {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pushedAuthorizationRequest"])(authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), params, {
                ...this.httpOptions(),
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests
            });
            let parRes;
            try {
                parRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processPushedAuthorizationResponse"])(authorizationServerMetadata, this.clientMetadata, response);
            } catch (e) {
                return [
    ...
    async getClientAuth() {
        ...
        if (clientPrivateKey && !(clientPrivateKey instanceof CryptoKey)) {
            clientPrivateKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$key$2f$import$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["importPKCS8"])(clientPrivateKey, this.clientAssertionSigningAlg);
        }
        return clientPrivateKey ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrivateKeyJwt"])(clientPrivateKey) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClientSecretPost"])(this.clientSecret);
    }
    get issuer() {
     ...
     */ async getConnectionTokenSet(tokenSet, connectionTokenSet, options) {
        ...
        if (tokenSet.refreshToken && (!connectionTokenSet || connectionTokenSet.expiresAt <= Date.now() / 1000)) {
            ...
            const httpResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["genericTokenEndpointRequest"])(authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), GRANT_TYPE_FEDERATED_CONNECTION_ACCESS_TOKEN, params, {
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests
            });
            let tokenEndpointResponse;
            try {
                tokenEndpointResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processGenericTokenEndpointResponse"])(authorizationServerMetadata, this.clientMetadata, httpResponse);
            } catch (err) {
                console.error(err);
                return [
...
class StatefulSessionStore extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$abstract$2d$session$2d$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AbstractSessionStore"] {
    ...
    async get(reqCookies) {
        ...
        let sessionId = null;
        try {
            const { payload: sessionCookie } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"])(cookie.value, this.secret);
            sessionId = sessionCookie.id;
        } catch (e) {
            // the session cookie could not be decrypted, try to verify if it's a legacy session
            if (e.code === "ERR_JWE_INVALID") {
                const legacySessionId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["verifySigned"])(cookie.name, cookie.value, this.secret);
                if (!legacySessionId) {
                    return null;
                }
    ...
    async set(reqCookies, resCookies, session, isNew = false) {
        ...
        if (cookieValue) {
            const { payload: sessionCookie } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"])(cookieValue, this.secret);
            sessionId = sessionCookie.id;
        }
        ...
        const jwe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"])({
            id: sessionId
        ...
        if (this.sessionCookieName !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"] && reqCookies.has(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"])) {
            resCookies.delete(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"]);
        }
    }
    async delete(reqCookies, resCookies) {
        ...
        const { payload: session } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"])(cookieValue, this.secret);
...
class StatelessSessionStore extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$abstract$2d$session$2d$store$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AbstractSessionStore"] {
    ...
    async get(reqCookies) {
        const cookieValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getChunkedCookie"])(this.sessionCookieName, reqCookies) ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getChunkedCookie"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"], reqCookies, true);
        if (!cookieValue) {
            return null;
        }
        const originalSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"])(cookieValue, this.secret);
     ...
     */ async set(reqCookies, resCookies, session) {
        ...
        const jwe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"])(originalSession, this.secret, expiration);
        const cookieValue = jwe.toString();
        const options = {
            ...this.cookieConfig,
            maxAge
        };
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setChunkedCookie"])(this.sessionCookieName, cookieValue, options, reqCookies, resCookies);
    ...
    async delete(reqCookies, resCookies) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteChunkedCookie"])(this.sessionCookieName, reqCookies, resCookies);
    ...
    async storeInCookie(reqCookies, resCookies, session, cookieName, maxAge) {
        const expiration = Math.floor(Date.now() / 1000 + maxAge);
        const jwe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"])(session, this.secret, expiration);
        const cookieValue = jwe.toString();
...
class TransactionStore {
    ...
    async save(resCookies, transactionState) {
        ...
        const jwe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"])(transactionState, this.secret, expiration);
    ...
    async get(reqCookies, state) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"])(cookieValue, this.secret);
    }
...
class Auth0Client {
     ...
     */ async getSession(req) {
        if (req) {
            // middleware usage
            if (req instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextRequest"]) {
...
"[project]/node_modules/@auth0/nextjs-auth0/dist/server/index.js [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40auth0_nextjs-auth0_c8c3c424._.js.map