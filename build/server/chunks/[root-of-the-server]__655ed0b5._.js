...
"[project]/.next-internal/server/app/api/conversations/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/queries/conversations.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "listConversationsForUser": (()=>listConversationsForUser)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
...
async function listConversationsForUser(userId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].selectFrom('conversations as c').leftJoin('petImages as pi', (join)=>join.onRef('pi.petId', '=', 'c.petId').on('pi.orderIdx', '=', 0)).leftJoin('messages as m', 'm.conversationId', 'c.id').select([
        'c.id',
        'c.petId',
        'c.adopterId',
        'c.ownerId',
        'c.createdAt',
        'pi.url as thumbUrl',
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`count(*) filter (
        where m.read_at is null
          and m.sender_id <> ${userId}
      )`.as('unread'),
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`max(m.sent_at)`.as('lastSentAt'),
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`max(m.body)`.as('lastBody')
    ]).where((eb)=>eb.or([
            eb('c.adopterId', '=', userId),
            eb('c.ownerId', '=', userId)
        ])).groupBy([
        'c.id',
        'c.petId',
        ...
        'c.createdAt',
        'pi.url'
    ]).orderBy(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`max(m.sent_at)`, 'desc').execute();
}
async function getOrCreateConversation(petId, adopterId, ownerId) {
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].selectFrom('conversations').select('id').where('petId', '=', petId).where('adopterId', '=', adopterId).where('ownerId', '=', ownerId).executeTakeFirst();
    if (existing) return existing.id;
    const { id } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insertInto('conversations').values({
        petId: petId,
        adopterId: adopterId,
        ownerId: ownerId
...
"[project]/src/app/api/conversations/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$conversations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/queries/conversations.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$conversations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$conversations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
async function DELETE(req, { params }) {
    try {
        ...
        const row = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].selectFrom('conversations').select('id').where('id', '=', params.id).where((eb)=>eb.or([
                eb('adopterId', '=', userId),
                eb('ownerId', '=', userId)
            ])).executeTakeFirst();
        if (!row) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Not found', 404);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$queries$2f$conversations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteConversation"])(params.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__655ed0b5._.js.map