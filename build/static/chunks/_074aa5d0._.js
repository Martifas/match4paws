...
;
;
/* ------------------------------------------------------------------ */ /* small local hook – handles form state & dirty flag                 */ /* ------------------------------------------------------------------ */ function useProfileForm(initial = {
    name: '',
    phone: '',
    address: ''
}) {
    ...
    // when the server user arrives → reset form & clear dirty
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s1(ProfileManagement, "V4wr8WbDFBuBQEZ2BcPqztG+q4k=", false, function() {
    return [
...
//# sourceMappingURL=_074aa5d0._.js.map